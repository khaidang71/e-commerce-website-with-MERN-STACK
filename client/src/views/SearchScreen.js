    ...
    switch (action.type) {
        ...
        case 'FETCH_SUCCESS':
            return {
                ...
                countooks: action.payload.countooks,
                loading: false,
            };
        case 'FETCH_FAIL':
...
export default function SearchScreen() {
    ...
    const [{ loading, error, books, pages, countooks }, dispatch] =
        useReducer(reducer, {
            loading: true,
            error: '',
        });
                    ...
                    {loading ? (
                        ...
                        <>
                            <Row className="justify-content-between mb-3">
                                <Col md={6}>
                                    <div>
                                        {countooks === 0 ? 'No' : countooks} Results
                                        {query !== 'all' && ' : ' + query}
                            ...
                            {books.length === 0 && (
                                <MessageBox>No Book Found</MessageBox>
                            )}
